    ...
    >
      <div class="w-1/2 pl-2 md:pl-0">
        <a
          ...
          href="#"
        >
          <i class="fas fa-sun text-pink-600 pr-3" />
          Admin Day Mode
        </a>
      </div>
      ...
      <div
        ...
        id="nav-content"
      >
        <ul class="list-none lg:flex flex-1 items-center px-4 md:px-0">
          <li class="mr-6 my-2 md:my-0">
            <a
              href="#"
              class="flex py-1 md:py-3 pl-1 align-middle text-pink-600 no-underline hover:text-gray-900 border-b-2 border-orange-600 hover:border-orange-600"
            >
              <i-fa-solid-home class="mr-3 text-ping-600" />
          ...
          <li class="mr-6 my-2 md:my-0">
            <a
              href="#"
              class="flex py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-pink-500"
            >
              <i-fa-solid-tasks class="mr-3" />
          ...
          <li class="mr-6 my-2 md:my-0">
            <a
              href="#"
              class="flex py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-purple-500"
            >
              <i-fa-solid-envelope class="fa-fw mr-3"/>
          ...
          <li class="mr-6 my-2 md:my-0">
            <a
              href="#"
              class="flex py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-green-500"
            >
              <i-fa-solid-chart-area class="fa-fw mr-3"/>
          ...
          <li class="mr-6 my-2 md:my-0">
            <a
              href="#"
              class="flex py-1 md:py-3 pl-1 items-center text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-red-500"
            >
              <i-fa-solid-wallet class="fa-fw mr-3"/>
